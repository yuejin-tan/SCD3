...
SCD_REG_ADD(CPU2CtrlEn, uint16_t)
...
SCD_REG_ADD(ad2s1210WaitCnt, int16_t)
...
SCD_REG_ADD(CH1_Iu_raw, int16_t)
SCD_REG_ADD(CH1_Iv_raw, int16_t)
SCD_REG_ADD(CH1_Iw_raw, int16_t)
SCD_REG_ADD(CH1_Idc_raw, int16_t)
SCD_REG_ADD(CH1_Iu_raw_offset, float)
SCD_REG_ADD(CH1_Iv_raw_offset, float)
SCD_REG_ADD(CH1_Iw_raw_offset, float)
SCD_REG_ADD(CH1_Idc_raw_offset, float)
